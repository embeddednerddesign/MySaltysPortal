...
@Component({
  selector: 'app-patient-nudges-tab',
  templateUrl: './patient-nudges-tab.component.html',
  styleUrls: ['./patient-nudges-tab.component.less']
})
export class PatientNudgesTabComponent implements OnInit, AfterViewInit, OnDestroy {
