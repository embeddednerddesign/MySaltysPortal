...
var Schedule = /** @class */ (function () {
    ...
    Schedule.prototype.initialize = function () {
        ...
        if (this.resources) {
            this.resources.forEach(resource => {
                this.schedule.fullCalendar('addResource', resource);
            });
        }
    ...
    Schedule.prototype.getView = function () {
        return this.schedule.fullCalendar('getView');
    };
    Schedule.prototype.getEventSources = function() {
        return this.schedule.fullCalendar('getEventSources');
    };
    Schedule.prototype.updateEvent = function (event) {
        this.schedule.fullCalendar('updateEvent', event);
    };
    Schedule.prototype.removeEvents = function (idOrFilter) {
        this.schedule.fullCalendar('removeEvents', idOrFilter);
    }
    Schedule.prototype.removeResource = function (idOrResource) {
        this.schedule.fullCalendar('removeResource', idOrResource);
    };
    Schedule.prototype.addResource = function (resource, scroll) {
        this.schedule.fullCalendar('addResource', resource, scroll);
    };
    Schedule.prototype.refetchResources = function () {
        this.schedule.fullCalendar('refetchResources');
    };
    Schedule.prototype.refetchEvents = function() {
        this.schedule.fullCalendar('refetchEvents');
    };
    Schedule.prototype.rerenderEvents = function() {
        this.schedule.fullCalendar('rerenderEvents');
    };
    Schedule.prototype.refetchEventSources = function(sources) {
        this.schedule.fullCalendar('refetchEventSources', sources)
    };
    Schedule.prototype.removeEventSource = function(source) {
        this.schedule.fullCalendar('removeEventSource', source);
    };
    Schedule.prototype.addEventSource = function(source) {
        this.schedule.fullCalendar('addEventSource', source);
    };
    Schedule.prototype.render = function() {
        this.schedule.fullCalendar('render');
    };
